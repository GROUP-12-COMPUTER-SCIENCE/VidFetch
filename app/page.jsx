  ...
  return (
    <main className={styles.main}>
      ...
      <div className="content">
        <div className="logo">
          <Image src={Logo} alt="VidFetch Logo" width={60} quality={100} />
          <h1>VidFetch</h1>
        </div>
        <h1>VidFetch - YouTube Video Downloader</h1>
        <h2>
          <small>
            Download YouTube videos effortlessly with VidFetch. Save your
            favorite videos for offline viewing, learning, or entertainment.
          </small>
        </h2>
        ...
        <div className="unique">
          ...
          <div className="accessibility">
            ...
            <h3>Accessibility</h3>
            <p>
              Download videos from any device, including mobile phones and
              tablets.
            </p>
          </div>
        </div>
